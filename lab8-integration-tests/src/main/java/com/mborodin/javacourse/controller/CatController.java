...
import com.mborodin.javacourse.service.CatService;
...
public class CatController {
    ...
    @GetMapping
    public Collection<Cat> getAllCats(@RequestParam(name = "behaviour", required = false) CatBehaviour behaviour) {
    ...
    @PutMapping("/{catName}")
    public Cat updateCat(@PathVariable("catName") String catName, @RequestBody Cat cat) {
    ...
    public Cat deleteCat(@PathVariable("catName") String catName) {
